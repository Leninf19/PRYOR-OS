...
const DATA_FILE_REGISTRY = [
  ...
  },
  {
    ...
    owner: 'n/a', marketing: 'n/a', location_manager: 'n/a', read_only: 'n/a',
    accessModel: 'GAP: the frozen architecture names this category but no such file exists today. The closest current artifact, analytics/location-stats.json, is a SINGLE company-wide file enumerating all locations together, not one file per location (it is catalogued under "company-wide KPIs" below, not here). Milestone 5 (Option C) is expected to introduce true per-location metric files extending the intelligence/locations/{slug}.json pattern.',
    milestone: 5,
  },
  {
  ...
  },
  {
    ...
    owner: 'n/a', marketing: 'n/a', location_manager: 'n/a', read_only: 'n/a',
    accessModel: 'GAP: same as per-location analytics -- not implemented today, expected to arrive as part of Milestone 5\'s per-location metric file set',
    milestone: 5,
  },
  {
