...
// ─── M5: reply-state model (Navigation/Design System/Execution Master Plan
...
// no reply needed") is intentionally NOT one of the 5 reply states; it keeps
// its own existing "Done" badge (STATUS_META.taken_care_of) unchanged.
const REPLY_STATE_META = {
...
function computeReplyState(r, wsEntry) {
